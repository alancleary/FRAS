#ifndef INCLUDED_CFG_AMT_COMPRESSED_INDEXED_CFG_V2
#define INCLUDED_CFG_AMT_COMPRESSED_INDEXED_CFG_V2
...
public:
     ...
     */
    static CompressedIndexedCFGV2* fromMrRepairFile(std::string filename);
     ...
     */
    static CompressedIndexedCFGV2* fromNavarroFiles(std::string filenameC, std::string filenameR);
     ...
     * @throws Exception if the files cannot be read.
     */
    static CompressedIndexedCFGV2* fromBigRepairFiles(std::string filenameC, std::string filenameR);
